...
<?php
$consultaContas = $oContas->listaTodasContas();
?>
<h1 class="page-title">
                    ...
                    <tbody>
                        ...
                        while ($contas = mysqli_fetch_array($consultaContas)) {
                            ...
                            <tr>
                                ...
                                <td><?= $contas['nome'] ?></td>
                                <td><?= $contas['nr_conta'] ?></td>
                                <td><?= $contas['nr_atendimento'] ?></td>
                                <td><?= $contas['dt_interna'] ?></td>
                                <td><?= $contas['dt_alta'] ?></td>
                                <td><?= $contas['tipo'] == 1 ? "Interno" : "Externo"; ?></td>
                                <td><?= $contas['dt_recbcta'] ?></td>
                                <td ><?= $contas['vlr_preglosa'] ?></td>
                                <td><?= $contas['vlr_posglosa'] ?></td>
                                <td><?= $contas['vlr_difglosa'] ?></td>
                            </tr>
                            <?php
                        }
                        ?>
