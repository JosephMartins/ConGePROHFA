...
<div class="modal fade bs-modal-lg" id="cadastrarAuditor" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="panel-body">
                        <div class="form-body">
                            <form role="form" name="form_login" method="POST" accept-charset="utf-8" action="<?php echo CONTROLLER . 'auditoria.php' ?>" onsubmit="return validaForm()">
                                ...
                                <input type="hidden" name="arrDadosForm[method]" value="cadastrarAuditor" />
                                <div class='row' style='margin-left: -0px !important; margin-right: -0px !important;'>
                                    <div class='form-group col-md-6'>
                                        <label style='text-align:left !important;' >Nome:</label>
                                        <input type="text" name="arrDadosForm[nome]"  class="form-control" required>
                                    </div>
                                    <div class='form-group col-md-6'>
                                        <label style='text-align:left !important;' >N º Doc:</label>
                                        <input type="number" class='form-control spinner' name='arrDadosForm[nr_docto]'>
                                    </div>
                                </div>
                                <div class='row' style='margin-left: -0px !important; margin-right: -0px !important;'>
                                    <div class="col-md-9">
