...
<div class="modal fade bs-modal-lg" id="editarPaciente" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" >
            <div class="modal-header" align="center">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title"><b>Alterar Paciente</b></h4>
            </div>
            <div class="modal-body">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title" id="tituloPaciente" style="text-align: center;"></h3>
                    </div>
                    <div class="panel-body">
                        <div class="form-body">
                            <form role="form" name="form_login" method="POST" accept-charset="utf-8" action="<?php echo CONTROLLER . 'paciente.php' ?>" onsubmit="return validaForm()">
                                ...
                                <input type="hidden" name="arrDadosForm[method]" value="alterarPaciente" />
                                <input type="hidden" name="arrDadosForm[campo_where]" value="nr_prontmv" />
                                <input id='idPaciente' type="hidden" name="arrDadosForm[id]" value="" />

                                <div class='row' style='margin-left: -0px !important; margin-right: -0px !important;'>
                                    <div class='form-group col-md-6'>
                                        <label style='text-align:left !important;' >Prontuario:<span class="required" aria-required="true">*</span></label>
                                        <input class='form-control spinner' id="prontuario" name='arrDadosForm[nr_prontmv]'  type='text' placeholder='Codigo do usuário' required='' value=''>
                                    </div>
                                    <div class='form-group col-md-6'>
                                        <label style='text-align:left !important;' >Nome:<span class="required" aria-required="true">*</span></label>
                                        <input class='form-control spinner' id="nome" name='arrDadosForm[nome]'  type='text' placeholder='Nome' required='' value=''>
                                    </div>
                                </div>
                                <div class='row' style='margin-left: -0px !important; margin-right: -0px !important;'>
                                    <div class='form-group col-md-6'>
                                        <label style='text-align:left !important;' >Convenio:<span class="required" aria-required="true">*</span></label>
                                        <select  class="form-control" name="arrDadosForm[cod_convenio]" id="convenio">
                                            <?php
