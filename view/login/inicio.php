...
<html lang="pt-br">
    ...
    <body class="login">
            ...
            <div class="logo">
                <center>
                    <table>
                        <tr>
                            <td>
                                <img src="<?php echo IMG; ?>hfa.png" height="100" alt="Defensoria Pública da União" >
                            </td>
                            <td>
                                <font size="5" color="#FFFFFF">HFA - Hospital das Forças Armadas<br></font>
                            </td>
                        </tr>
                    </table>
                </center>
        ...
        <div class="clearfix visible-xs-block visible-sm-block">
            <p align="center">
                <img src="<?php echo IMG; ?>hfa.png" height="100" alt="">
                <br/><br/>
                <font size="4" color="#FFFFFF">HFA - Hospital das Forças Armadas</font>
            </p>
        </div>
        <!-- FIM LOGO -->
            ...
            <form class="login-form" role="form" name="form_login" method="POST" accept-charset="utf-8" action="<?php echo CONTROLLER . 'login.php' ?>">
                ...
                <div class="create-account">
                    <center>
                        ...
                        <p>+55 (61)98602-3581   martins.josemn@gmail.com<p/>
                    </center>
                </div>
            </form>
