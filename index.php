...
<?php if (@$_SESSION['VALID'] and ( $modulo != 'login' )) { ?>
    ...
    <html lang="br">
        <head>
            ...
            <link href="<?php echo CSS; ?>theme-layout/blue.css" rel="stylesheet" type="text/css" id="style_color" />       <!-- Cores do template: blue.css, light.css, grey.css, dark.css  -->
            <link href="<?php echo CSS; ?>theme-layout/customizar.css" rel="stylesheet" type="text/css" />
            <!-- END THEME LAYOUT STYLES -->

            <link rel="shortcut icon" href="<?php echo IMG; ?>bandeira.ico" />
            ...
            <script src="<?php echo JS; ?>bootstrap-daterangepicker/select2.full.js" type="text/javascript"></script>
            <script src="<?php echo JS; ?>jquery.maskMoney.js" type="text/javascript"></script>
            <!-- END CORE PLUGINS -->
